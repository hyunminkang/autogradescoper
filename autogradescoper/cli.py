...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: autogradescoper <command> <args>, autogradescoper <command> -h to see arguments for each command")
    ...
    module_name = "autogradescoper.scripts." + module_map[function_name]
